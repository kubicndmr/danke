...
def gen_data(tokenizer, language_model, pocap):
    ...
    cluster_prompt = {
        ...
        'Katheterpositionierung': '''In der Phase Katheterpositionierung: fünf Mal Aussagen wie 1) "Bitte atmen Sie tief ein." 2) "Atmen Sie ganz tief ein und halten Sie die Luft an." 3) "Jetzt bitte tief einatmen." wurden während der Röntgenaufnahme geäußert, um die Durchleuchtungsstelle leichter erkennbar zu machen. Vier Mal Aussagen wie 1) "Der Portschlauch ist jetzt platziert, nun verbinden wir ihn mit der Katheter. 2) "Wir verbinden den Schlauch mit der Kammer." 3) "Wir stellen jetzt die Länge des Portschlauchs ein." wurden geäußert, um den Patient über den Schritt '4.3) Positionierung des Katheters' zu informieren. Drei Mal Aussagen wie 1) "Wir warten kurz, bis die Blutstillung abgeschlossen ist." 2) "Wir lassen es kurz ruhen, damit es nicht blutet." 3) "Wir warten, bis die Tasche hier bis ins Blut raufkönnt." geäußert.''',
        'Katheteranpassung': '''In der Phase Katheteranpassung: 43 Mal Aussagen wie 1) "Bitte atmen Sie tief ein und halten Sie die Luft an." 2) "Atmen Sie ganz tief aus und pressen Sie alles raus." 3) "Atmen Sie ruhig und halten Sie die Luft an, wenn ich es sage." wurden während der Röntgenaufnahme geäußert, um die Durchleuchtungsstelle leichter erkennbar zu machen.''',
        'Katheterkontrolle': '''In der Phase Katheterkontrolle 21 Mal Aussagen wie 1) "Bitte atmen Sie tief ein und halten Sie die Luft an." 2) "Halten Sie die Luft an und bewegen Sie sich nicht." 3) "Sie bekommen gleich ein Atemkommando, bitte atmen Sie tief ein und halten Sie die Luft an." wurden während der Röntgenaufnahme geäußert, um die Durchleuchtungsstelle leichter erkennbar zu machen.''',
        'Abschluss': '''In der Phase Abschluss: neun Mal Aussagen wie 1) "Wir kleben jetzt ein Pflaster darauf." 2) "Das Pflaster kann später einfach abgezogen werden." 3) "Sie bekommen ein Ersatzpflaster mit." wurden geäußert, um den Patient über den Schritt '7.1) Steriles Pflaster auflegen' zu informieren.'''
    }
    ...
    toc_bezeichnung = df_sample['ToC_Bezeichnung'].tolist()
